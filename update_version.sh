...
KUSANAGI_NGINX129_IMAGE=${PS}-nginx:$(k_version nginx 1.29)
KUSANAGI_NGINX_IMAGE=${PS}-nginx:$(k_version nginx 1.29)
...
KUSANAGI_PHP85_IMAGE=${PS}-php:$(k_version php 8.5)
KUSANAGI_PHP_IMAGE=${PS}-php:$(k_version php 8.3)
...
KUSANAGI_MYSQL118_IMAGE=mariadb:$(mariadb_version 11.8)
