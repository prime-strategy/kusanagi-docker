...
KUSANAGI_NGINX118_IMAGE=${PS}-nginx:$(k_version nginx 1.18)
KUSANAGI_NGINX119_IMAGE=${PS}-nginx:$(k_version nginx 1.19)
KUSANAGI_NGINX_IMAGE=${PS}-nginx:$(k_version nginx 1.19)
