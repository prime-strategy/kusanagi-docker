...
KUSANAGI_NGINX125_IMAGE=${PS}-nginx:$(k_version nginx 1.25)
KUSANAGI_NGINX_IMAGE=${PS}-nginx:$(k_version nginx 1.25)
...
KUSANAGI_MYSQL1010_IMAGE=mariadb:$(mariadb_version 10.10)
